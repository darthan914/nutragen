...
@section('content')
	...
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('backend.distribution.update', $index->id) }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="image_height" name="image_height" class="form-control {{$errors->first('image_height') != '' ? 'parsley-error' : ''}}" value="{{ old('image_height', $index->image_height) }}" placeholder="default: 30">
				<ul class="parsley-errors-list filled">
