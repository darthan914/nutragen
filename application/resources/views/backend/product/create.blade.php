...
@section('content')
	...
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('backend.product.store') }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<textarea type="text" id="short_description" name="short_description" class="form-control {{$errors->first('short_description') != '' ? 'parsley-error' : ''}}" value="">{{ old('short_description') }}</textarea>
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<textarea type="text" id="description" name="description" class="form-control {{$errors->first('description') != '' ? 'parsley-error' : ''}}">{{ old('description') }}</textarea>
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			<label for="image_logo" class="control-label col-md-3 col-sm-3 col-xs-12">Image Logo <span class="required">*</span>
			</label>
			<div class="col-md-9 col-sm-9 col-xs-12">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="image_logo_height" name="image_logo_height" class="form-control {{$errors->first('image_logo_height') != '' ? 'parsley-error' : ''}}" value="{{ old('image_logo_height') }}" placeholder="default: autoheight">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			<label for="image_product" class="control-label col-md-3 col-sm-3 col-xs-12">Image Product <span class="required">*</span>
			</label>
			<div class="col-md-9 col-sm-9 col-xs-12">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="image_product_height" name="image_product_height" class="form-control {{$errors->first('image_product_height') != '' ? 'parsley-error' : ''}}" value="{{ old('image_product_height') }}" placeholder="default: autowidth">
				<ul class="parsley-errors-list filled">
