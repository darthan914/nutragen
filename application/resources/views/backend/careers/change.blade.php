...
@section('title')
  <title>{{ $name->title }} | Change {{ $Careers->name }} | Careers</title>
@endsection
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Change {{ $Careers->name }} Careers<small></small></h2>
      ...
      <div class="x_content">
        <form action="{{ route('backend.careers.change.store', ['id'=>$Careers->id]) }}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
          {{ csrf_field() }}
          ...
          <div class="item form-group {{ $errors->has('name') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="name" class="form-control col-md-7 col-xs-12" name="name" placeholder="Name" required="required" type="text" value="{{ old('name',$Careers->name) }}">
              @if($errors->has('name'))
          ...
          <div class="item form-group {{ $errors->has('job_type') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="job_type" class="form-control col-md-7 col-xs-12" name="job_type" placeholder="Job Type" required="required" type="text" value="{{ old('job_type',$Careers->job_type) }}">
          ...
          <div class="item form-group {{ $errors->has('location') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="location" class="form-control col-md-7 col-xs-12" name="location" placeholder="Location" required="required" type="text" value="{{ old('location',$Careers->location) }}">
          ...
          <div class="item form-group {{ $errors->has('contract') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="contract" class="form-control col-md-7 col-xs-12" name="contract" placeholder="Contract" required="required" type="text" value="{{ old('contract',$Careers->contract) }}">
          ...
          <div class="item form-group {{ $errors->has('vacancy') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="vacancy" class="form-control col-md-7 col-xs-12" name="vacancy" placeholder="Vacancy" required="required" type="text" value="{{ old('vacancy',$Careers->vacancy) }}">
          ...
          <div class="item form-group {{ $errors->has('job_description') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="job_description" required="required" name="job_description">{{ old('job_description',$Careers->job_description) }}</textarea>
          ...
          <div class="item form-group {{ $errors->has('responsibilities') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="responsibilities" required="required" name="responsibilities">{{ old('responsibilities',$Careers->responsibilities) }}</textarea>
          ...
          <div class="item form-group {{ $errors->has('qualifications') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="qualifications" required="required" name="qualifications">{{ old('qualifications',$Careers->qualifications) }}</textarea>
