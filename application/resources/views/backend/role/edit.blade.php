...
@section('content')
	...
	<h1>Edit Role</h1>
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('backend.role.update', ['id' => $index->id]) }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="code" name="code" class="form-control {{$errors->first('code') != '' ? 'parsley-error' : ''}}" value="{{ old('code', $index->code) }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<label class="checkbox-inline"><input type="checkbox" value="1" name="active" @if(old('active', $index->active) == "1") checked @endif>Active</label>
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<label class="checkbox-inline"><input type="checkbox" name="permission[]" class="group-superadmin" value="config" @if(in_array('config', old('permission', explode(', ', $index->permission)))) checked @endif>Configuration</label>
				<ul class="parsley-errors-list filled">
