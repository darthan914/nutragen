...
@section('title')
  <title>{{ $name->title }} | Add | News</title>
@endsection
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form action="{{ route('backend.news.store') }}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
          {{ csrf_field() }}
          ...
          <div class="item form-group {{ $errors->has('descript') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="descript" required="required" name="descript">{{ old('descript') }}</textarea>
